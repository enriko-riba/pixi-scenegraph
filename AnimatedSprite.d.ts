...
export declare class AnimatedSprite extends PIXI.Sprite {
    ...
    addAnimations(...sequences: Array<AnimationSequence>): void;
...
export declare class AnimationSequence {
    ...
    constructor(sequenceName: string, spriteSheetName: string, frames: number[] | undefined, frameWidth: number, frameHeight: number);
